...
public class Principal {
    ...
    public void exibeMenu(){
        ...
        private void buscaEpisodioPorTrecho(){
            ...
            List<Episodios> episodiosEncontrados = repository.episodioPorTrecho(trechoEpisodio);
        ...
        private void buscarEpisodiosDepoisDeUmaData(){
            ...
            if (serieBusca.isPresent()){
                ...
                List<Episodios> episodiosANo = repository.episodioPorSerieEAno(serie, anoLancamento);
